            ...
            <div
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <h3 className="text-xl font-medium text-gray-900 dark:text-white">Sign up to our platform</h3>
                        <div>
                            <label htmlFor="email" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Your password</label>
                        ...
                        <div className="flex justify-center text-sm font-medium text-gray-500 dark:text-gray-300">
                            Have registered? <Link href="/login" className=" ml-2 text-blue-700 hover:underline dark:text-blue-500">Sign in here</Link>
                        </div>
                </form>
            </div>
        </div>
