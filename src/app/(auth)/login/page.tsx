...
export default function LoginPage({searchParams} : any){
    ...
    return (
        <div className="h-screen w-100vh flex justify-center items-center bg-gray-800 flex-col">
            ...
            <div
                className="bg-white shadow-md border border-gray-200 rounded-lg w-90 p-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <input type="password" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required/>
                                ...
                                <hr />
                                <button onClick={handleLoginGoogle} disabled={isLoading} type="button" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{isLoading ? "Loading..." : "Login With Google"}</button>
                                <div className="flex justify-center text-sm font-medium text-gray-500 dark:text-gray-300">
                                    Not registered? <Link href="/register" className="ml-2 text-blue-700 hover:underline dark:text-blue-500">Create
                                        account</Link>
                                </div>
                </form>
            </div>
